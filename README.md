...
1. HACS → Custom repositories → add `https://github.com/Bluey78532/sinewerx-mesh-ha` as **Integration** (or use the badge above).
...
The old repository URL `cattle-sprayer-mesh-ha` redirects here.
