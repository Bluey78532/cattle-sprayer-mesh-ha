> **This repository was renamed.** Prefer: https://github.com/Bluey78532/sinewerx-mesh-ha  
> HACS custom repository: `Bluey78532/sinewerx-mesh-ha`
# Sinewerx Mesh â€” Home Assistant
...
If the gateway **Settings â†’ Home Assistant MQTT** has a broker set, use the built-in **MQTT** integration instead. Use this HACS integration when you do not want MQTT.

## Install

1. HACS â†’ Custom repositories â†’ add `https://github.com/Bluey78532/sinewerx-mesh-ha` as **Integration**.
2. Download **Sinewerx Mesh**, then restart Home Assistant.
3. Settings â†’ Devices & services â†’ Add integration â†’ **Sinewerx Mesh**.
