...
Public HACS package: https://github.com/Bluey78532/cattle-sprayer-mesh-ha

This folder in the product repo is the development copy. Push updates to the public repo for farmers/HACS.

Connects Home Assistant to a house MeshCore **Wi‑Fi gateway** (TCP port **5000**, SoftAP-provisioned Xiao S3 WIO) or **USB serial**, applies the SoftAP pairing card, and creates sprayer devices from `CS …` channel messages.
